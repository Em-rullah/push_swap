...
/*   Updated: 2025/11/05 13:56:03 by emkir            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	move_up_a(t_node *next_to, t_stack *from, t_stack *to, int *counter)
{
	int	move_from;
	int	move_to;
...
static void	move_up_b(t_node *next_to, t_stack *from, t_stack *to, int *counter)
{
	int	move_from;
	int	move_to;
...
static void	move_down(t_node *next_to, t_stack *from, t_stack *to, int *counter)
{
	int	move_from;
	int	move_to;
